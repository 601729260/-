...
select a.sid,a.item_num_id,a.pre_avarage_cost_price,b.cost_price/100 ,a.pre_total_cost_price,case when a.pre_total_num<0 then 0 else a.pre_total_num end from  t_average_cost_price_log a left join gb_share_item_ext b on a.item_num_id=b.item_num_id
