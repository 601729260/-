...
WHERE
	T2.SYNC_BATCH_ID IN ( 201808220946482607, 201808311056395579, 201810130945551850 );
...
WHERE
	...
	AND T1.SYNC_BATCH_ID IN ( 201808220946482607, 201808311056395579, 201810130945551850 );
...
FROM
	GB_STORAGE_O2O_TEMP 
WHERE
	SYNC_BATCH_ID IN ( 201808220946482607, 201808311056395579, 201810130945551850 );
