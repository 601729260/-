...
alter table u_stock_log_detail modify `qty` int(10) DEFAULT NULL COMMENT '当前门店app库存，必填 #AC|显示，必填#R|显示';
alter table u_stock_log_detail modify purchase_price decimal(20,2) DEFAULT NULL COMMENT '进价 退货单价 #R|显示 ';
alter table u_stock_log_detail modify total_purchase_price decimal(20,2) DEFAULT NULL COMMENT '进价金额 退货金额 #R|显示';
alter table u_stock_log_detail modify `one_value` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '规格第一标题对应的值，必填#AS|显示#R|显示';
alter table u_stock_log_detail modify  `style_code` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '商品货号，必填 #R|显示 ';
alter table u_stock_log_detail modify  `id` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '单据编号，必填 #U|显示#AC|显示，必填#AS|显示#AU|显示#R|显示';


CREATE TABLE `u_stock_log_detail` (
`seq_id` bigint(18) NOT NULL AUTO_INCREMENT COMMENT '默认自增主键||隐藏',
`id` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '单据编号，必填 #U|显示#AC|显示，必填#AS|显示#AU|显示#R|显示',
...
`style_code` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '商品货号，必填 #R|显示 ',
`style_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '商品名称，必填   #AS|显示#R|显示',
purchase_price decimal(20,2) DEFAULT NULL COMMENT '进价 退货单价 #R|显示 ',
total_purchase_price decimal(20,2) DEFAULT NULL COMMENT '进价金额 退货金额 #R|显示',
...
`qty` int(10) DEFAULT NULL COMMENT '当前门店app库存，必填 #AC|显示，必填#R|显示',
...
`one_value` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '规格第一标题对应的值，必填#AS|显示#R|显示',
