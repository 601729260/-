...
inner join mamahao_warehouse.u_goods_stock_log e on a.id=e.id and e.item_num_id=a.item_num_id
WHERE
	a.bill_type = 6 
	AND a.STATUS  in(13)  
	AND e.create_time > '2019-09-01 00:00:00' 
		AND e.create_time < '2019-09-30 23:59:59' 
