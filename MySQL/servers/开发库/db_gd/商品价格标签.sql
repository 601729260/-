...
select * from price_label;
 ...
 alter table price_label add have_direct_bonus int(8) comment '是否有星店长佣金';
 alter table price_label add direct_bonus  decimal(20,2) comment '实习星店长直属佣金';
 alter table price_label add have_star_commission int(8) comment '本门店是否参与星店长';
 
 
 select * from price_label where sid=1500000102;
