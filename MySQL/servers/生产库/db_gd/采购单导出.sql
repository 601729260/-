...
inner join (select id,item_num_id,sum(p_qty_change) as p_qty_change from u_goods_stock_log where create_time >'2019-08-01 00:00:00' and create_time <'2019-08-31 23:59:59'  group by id,item_num_id ) e on a.id=e.id and e.item_num_id=a.item_num_id
WHERE
	a.bill_type = 0 
	AND a.STATUS  in(2,3)  
